...
function App() {
    ...
    const [opmeringen, setOpmerkingen] = useState("");
    ...
    const formHandlerAchterNaam = (e) => {
        setAchterNaam(e.target.value);
    };
    const formHandlerLeeftijd = (e) => {
        setLeeftijd(e.target.value);
    };
    const formHandlerPostcode = (e) => {
        setPostcode(e.target.value);
    };
    const formHandlerBezorgFrequentie = (e) => {
        setBezorgFrequentie(e.target.value);
    };
    const formHandlerTijdvak = (e) => {
        setTijdvak(e.target.value);
    };
    const formHandlerOpmerkingen = (e) => {
        setOpmerkingen(e.target.value);
    };
    const formHandlerAkkoord = (e) =>
    {
        ...
        const handleSubmit = (e) => {
            ...
            console.log("Bezorgfrequentie: ", bezorgfrequentie);
            console.log("Tijdvak: ", tijdvak);
            console.log("Opmerking: ", opmerkingen);
            console.log("Akkoord met voorwaarden: ", akkoord);
        };
            ...
            <main>
                <section>
                    ...
                    <article><label htmlFor="reset>">Reset</label>
                        <button type="button" name="reset" onClick={resetCounter}>Reset</button>
                    </article>
                </section>
                <section>
                    <form onSubmit={handleSubmit}>
                        ...
                        <input type="text" name="achternaam" onChange={formHandlerAchterNaam}
                               value={achterNaam}></input>
                        ...
                        <select name="bezorgFrequentie" value={bezorgfrequentie} onChange={formHandlerBezorgFrequentie}
                    ...
                    <input type="radio"
                           ...
                           onChange={formHandlerTijdvak}
                    />
                    <input type="textarea"
                           name="opmerkingen
id=" opmerkingen"
value={opmerkingen}
onChange={formHandlerOpmerkingen}
rows="4"
                    columns="50"
                    placeholder="Schrijf uw opmerkingen hier"/>
                    <label htmlFor="voorwaarden">
                        <input
                            type="checkbox"
                            name="voorwaarden" id="voorwaarden"
                            checked={akkoord}
                            onChange={formHandlerAkkoord}/>
                        Ik ga akkoord met de voorwaarden
                    </label>


                    <button type="submit" disabled={!akkoord}>Submit</button>
                </form>
            </section>
            </main>
